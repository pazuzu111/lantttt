...
export const fetchData2 = async location => {
  let res = await axios.get(
    `https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=florist&location=${location}&limit=20`,
    {
      headers: {
        Authorization: `Bearer 9YJcYeZhc9qVetVvPVIOmED9tFFeptnsX_KMrT0SXEcjIV4OZpq9vHoScWpJKKe1DRuj2CN9HtLBOJmAcScym6SLhLq0BckJ7OQM0avfziRoFh2nPWVzatvWBKLVXXYx`
      }
